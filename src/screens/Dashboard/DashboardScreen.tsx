    ...
    return (
        <MainLayout bg={"cyan.50"}>
            <VStack safeArea bg={"orange.600"} flex={1}>
                ...
                <Center mt={20} mx={8}>
                    <Image source={require("~/assets/images/logoWhite.png")} alt={"logo"} resizeMode={"center"} w={"48"}
                           height={"24"}/>
                ...
                <HStack mt={4} px={8} space={"sm"} flexWrap={"wrap"} justifyContent={"flex-end"} flexDir={"row"}>
                    <Button rounded={"full"} px={6} bg={"black"} h={"12"} _text={{fontWeight: "600"}} mt={4}>نقاش
                        لازمم</Button>
                    <Button rounded={"full"} px={6} bg={"black"} fontWeight={"600"} h={"12"} _text={{fontWeight: "600"}}
                            mt={4}>
